...
MOTOR_DUTY_PERCENT = 90
MOTOR_MAX_DUTY_PERCENT = 100
...
TARGET_CONFIDENCE_SLOWDOWN_BELOW = 0.24
TARGET_CONFIDENCE_SLOWDOWN_AMOUNT = 0.35

SPEED_PID_KP = 0.08 # 0.05 # 0.04 # 0.020
...
LOOKAHEAD_BRAKE_START_DEG = 4.5 # 5.0 # 8.0
...
LOOKAHEAD_SPEED_MAX_DUTY_DROP = 3 # 4 # 7 # 15          # max duty removed from far-field change
...
MIN_BLOB_DENSITY = 0.09 # 0.10  # 0.18
